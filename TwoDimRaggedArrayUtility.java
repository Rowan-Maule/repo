...
public class TwoDimRaggedArrayUtility {
	...
	public static void main(String[] args) throws FileNotFoundException
	{
		...
		double tempArray[][] = readFile(file);
		
		for(int i = 0; i < tempArray.length; i++)
		{
			for(int b = 0; b < tempArray[i].length; b++)
			{
				System.out.print(tempArray[i][b] + " ");
			}
			System.out.print("\n");
		}
		...
		writeToFile(tempArray, output);
		
		System.out.println("Total Avg: " + getAverage(tempArray));
		System.out.println("Row Total: " + getRowTotal(tempArray, 2));
		System.out.println("Col Total: " + getColumnTotal(tempArray, 2));
		System.out.println("Highest in Row: " + getHighestInRow(tempArray, 2) + " Index: " + getHighestInRowIndex(tempArray, 2));
		System.out.println("Lowest in Row: " + getLowestInRow(tempArray, 2) + " Index: " + getLowestInRowIndex(tempArray, 2));
		System.out.println("Highest in Col: " + getHighestInColumn(tempArray, 2) + " Index: " + getHighestInColumnIndex(tempArray, 2));
		System.out.println("Lowest in Col: " + getLowestInColumn(tempArray,	2) + " Index: " + getLowestInColumnIndex(tempArray, 2));
		System.out.println("Highest in Array: " + getHighestInArray(tempArray));
		System.out.println("Lowest in Array: " + getLowestInArray(tempArray));
	}
